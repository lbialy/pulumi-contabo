...
// RegionChangeRequest struct for RegionChangeRequest
type RegionChangeRequest struct {
	// Target region identifier passed to CMS
	Region string `json:"region"`
	// Region change method as defined by CMS
...
func (o RegionChangeRequest) MarshalJSON() ([]byte, error) {
...
type NullableRegionChangeRequest struct {
	value *RegionChangeRequest
	isSet bool
}

func (v NullableRegionChangeRequest) Get() *RegionChangeRequest {
	return v.value
}

func (v *NullableRegionChangeRequest) Set(val *RegionChangeRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionChangeRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionChangeRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionChangeRequest(val *RegionChangeRequest) *NullableRegionChangeRequest {
	return &NullableRegionChangeRequest{value: val, isSet: true}
}

func (v NullableRegionChangeRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionChangeRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
