...
type InstanceResponse struct {
	...
	// Image's id. Null for empty (imageless) instances.
...
func (o *InstanceResponse) HasImageId() bool {
...
func (o *InstanceResponse) SetImageIdNil() {
	o.ImageId.Set(nil)
}

// UnsetImageId ensures that no value is present for ImageId, not even an explicit nil
func (o *InstanceResponse) UnsetImageId() {
	o.ImageId.Unset()
}
