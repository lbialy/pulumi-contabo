...
// UserSwitchAccountResponse struct for UserSwitchAccountResponse
type UserSwitchAccountResponse struct {
	Data []UserSwitchAccountTokens `json:"data"`
...
func NewUserSwitchAccountResponse(data []UserSwitchAccountTokens, links SelfLinks) *UserSwitchAccountResponse {
	this := UserSwitchAccountResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *UserSwitchAccountResponse) GetData() []UserSwitchAccountTokens {
	if o == nil {
		var ret []UserSwitchAccountTokens
		return ret
	}
...
func (o UserSwitchAccountResponse) MarshalJSON() ([]byte, error) {
...
type NullableUserSwitchAccountResponse struct {
	value *UserSwitchAccountResponse
	isSet bool
}

func (v NullableUserSwitchAccountResponse) Get() *UserSwitchAccountResponse {
	return v.value
}

func (v *NullableUserSwitchAccountResponse) Set(val *UserSwitchAccountResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSwitchAccountResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSwitchAccountResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSwitchAccountResponse(val *UserSwitchAccountResponse) *NullableUserSwitchAccountResponse {
	return &NullableUserSwitchAccountResponse{value: val, isSet: true}
}

func (v NullableUserSwitchAccountResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSwitchAccountResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
