...
// DomainPendingActionResponse struct for DomainPendingActionResponse
type DomainPendingActionResponse struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// OpusDNS domain id (mirrors the local domain `opusId`)
	DomainId string `json:"domainId"`
	// Domain name (sld.tld)
	Domain string `json:"domain"`
	// Event type — always OUTBOUND_TRANSFER for this endpoint
	EventType string `json:"eventType"`
	// OpusDNS event id to ACK/NACK against
	EventId string `json:"eventId"`
	// When OpusDNS created the transfer-out event
...
func NewDomainPendingActionResponse(tenantId string, customerId string, domainId string, domain string, eventType string, eventId string, createdOn time.Time) *DomainPendingActionResponse {
	this := DomainPendingActionResponse{}
...
func (o DomainPendingActionResponse) MarshalJSON() ([]byte, error) {
...
type NullableDomainPendingActionResponse struct {
	value *DomainPendingActionResponse
	isSet bool
}

func (v NullableDomainPendingActionResponse) Get() *DomainPendingActionResponse {
	return v.value
}

func (v *NullableDomainPendingActionResponse) Set(val *DomainPendingActionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDomainPendingActionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDomainPendingActionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDomainPendingActionResponse(val *DomainPendingActionResponse) *NullableDomainPendingActionResponse {
	return &NullableDomainPendingActionResponse{value: val, isSet: true}
}

func (v NullableDomainPendingActionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDomainPendingActionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
