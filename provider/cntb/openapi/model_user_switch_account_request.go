...
// UserSwitchAccountRequest struct for UserSwitchAccountRequest
type UserSwitchAccountRequest struct {
	// Customer ID
...
func (o UserSwitchAccountRequest) MarshalJSON() ([]byte, error) {
...
type NullableUserSwitchAccountRequest struct {
	value *UserSwitchAccountRequest
	isSet bool
}

func (v NullableUserSwitchAccountRequest) Get() *UserSwitchAccountRequest {
	return v.value
}

func (v *NullableUserSwitchAccountRequest) Set(val *UserSwitchAccountRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSwitchAccountRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSwitchAccountRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSwitchAccountRequest(val *UserSwitchAccountRequest) *NullableUserSwitchAccountRequest {
	return &NullableUserSwitchAccountRequest{value: val, isSet: true}
}

func (v NullableUserSwitchAccountRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSwitchAccountRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
