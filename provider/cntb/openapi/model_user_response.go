...
type UserResponse struct {
	...
	// If enabled, the user receives invoice emails and is registered as an invoice contact in CMS.
	SendInvoiceEmail bool `json:"sendInvoiceEmail"`
}
...
// GetSendInvoiceEmail returns the SendInvoiceEmail field value
...
// GetSendInvoiceEmailOk returns a tuple with the SendInvoiceEmail field value
// and a boolean to check if the value has been set.
...
// SetSendInvoiceEmail sets field value
