...
// ExtCheckCollectionTemplateResponse struct for ExtCheckCollectionTemplateResponse
type ExtCheckCollectionTemplateResponse struct {
...
func NewExtCheckCollectionTemplateResponse(checkCollectionTemplateId float32, name string, description string, internal bool, objectType string, checkTemplates []CheckCollectionTemplatesCheckTemplates, createdDate time.Time, modifiedDate time.Time, tenantId string, customerId string) *ExtCheckCollectionTemplateResponse {
	this := ExtCheckCollectionTemplateResponse{}
...
func (o ExtCheckCollectionTemplateResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtCheckCollectionTemplateResponse struct {
	value *ExtCheckCollectionTemplateResponse
	isSet bool
}

func (v NullableExtCheckCollectionTemplateResponse) Get() *ExtCheckCollectionTemplateResponse {
	return v.value
}

func (v *NullableExtCheckCollectionTemplateResponse) Set(val *ExtCheckCollectionTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtCheckCollectionTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtCheckCollectionTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtCheckCollectionTemplateResponse(val *ExtCheckCollectionTemplateResponse) *NullableExtCheckCollectionTemplateResponse {
	return &NullableExtCheckCollectionTemplateResponse{value: val, isSet: true}
}

func (v NullableExtCheckCollectionTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtCheckCollectionTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
