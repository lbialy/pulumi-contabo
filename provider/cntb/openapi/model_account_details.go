...
type AccountDetails struct {
	...
	// Tenant ID of the sub account.
	TenantId NullableString `json:"tenantId"`
	// Customer account type (from customer record). Example values are `private` or `business`.
	Type NullableString `json:"type"`
	// Customer company name (from customer record).
	Company NullableString `json:"company"`
	// The email displayed for this account.
	Email NullableString `json:"email"`
	// First name associated with this account.
	FirstName NullableString `json:"firstName"`
	// Last name associated with this account.
