...
// SupportSignatureResponse struct for SupportSignatureResponse
type SupportSignatureResponse struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// HMAC-SHA256 signature of the user id, hex encoded.
	Id string `json:"id"`
	// Signature lifetime in seconds.
	Validity float32 `json:"validity"`
	// Unix timestamp (seconds) at which the signature expires. Passed to Decagon as the epoch.
	Timestamp float32 `json:"timestamp"`
	// Signing system identifier.
...
func (o SupportSignatureResponse) MarshalJSON() ([]byte, error) {
...
type NullableSupportSignatureResponse struct {
	value *SupportSignatureResponse
	isSet bool
}

func (v NullableSupportSignatureResponse) Get() *SupportSignatureResponse {
	return v.value
}

func (v *NullableSupportSignatureResponse) Set(val *SupportSignatureResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportSignatureResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportSignatureResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportSignatureResponse(val *SupportSignatureResponse) *NullableSupportSignatureResponse {
	return &NullableSupportSignatureResponse{value: val, isSet: true}
}

func (v NullableSupportSignatureResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportSignatureResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
