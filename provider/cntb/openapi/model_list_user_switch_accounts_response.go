...
// ListUserSwitchAccountsResponse struct for ListUserSwitchAccountsResponse
type ListUserSwitchAccountsResponse struct {
...
func NewListUserSwitchAccountsResponse(pagination PaginationMeta, data []UserSwitchAccount, links Links) *ListUserSwitchAccountsResponse {
	this := ListUserSwitchAccountsResponse{}
...
func (o ListUserSwitchAccountsResponse) MarshalJSON() ([]byte, error) {
...
type NullableListUserSwitchAccountsResponse struct {
	value *ListUserSwitchAccountsResponse
	isSet bool
}

func (v NullableListUserSwitchAccountsResponse) Get() *ListUserSwitchAccountsResponse {
	return v.value
}

func (v *NullableListUserSwitchAccountsResponse) Set(val *ListUserSwitchAccountsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListUserSwitchAccountsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListUserSwitchAccountsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListUserSwitchAccountsResponse(val *ListUserSwitchAccountsResponse) *NullableListUserSwitchAccountsResponse {
	return &NullableListUserSwitchAccountsResponse{value: val, isSet: true}
}

func (v NullableListUserSwitchAccountsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListUserSwitchAccountsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
