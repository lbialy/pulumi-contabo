...
type ApiCheckSetNewHostRequest struct {
	ctx _context.Context
	ApiService *InstancesApiService
	xRequestId *string
	instanceId int64
...
// [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
func (r ApiCheckSetNewHostRequest) XRequestId(xRequestId string) ApiCheckSetNewHostRequest {
	r.xRequestId = &xRequestId
	return r
}
// Identifier to trace group of requests.
func (r ApiCheckSetNewHostRequest) XTraceId(xTraceId string) ApiCheckSetNewHostRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiCheckSetNewHostRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.CheckSetNewHostExecute(r)
}

/*
CheckSetNewHost Check if the instance can be moved to another host
...
Verifies preconditions with CMS before relocating the instance from its current host. Returns no content when the check succeeds. When CMS responds with an error list, returns that payload with the same HTTP status as CMS.
 ...
 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param instanceId The identifier of the instance
 @return ApiCheckSetNewHostRequest
*/
func (a *InstancesApiService) CheckSetNewHost(ctx _context.Context, instanceId int64) ApiCheckSetNewHostRequest {
	return ApiCheckSetNewHostRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
// Execute executes the request
func (a *InstancesApiService) CheckSetNewHostExecute(r ApiCheckSetNewHostRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InstancesApiService.CheckSetNewHost")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/compute/instances/{instanceId}/regionChange/check"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", _neturl.PathEscape(parameterToString(r.instanceId, "")), -1)
...
type ApiRequestRegionChangeRequest struct {
	ctx _context.Context
	ApiService *InstancesApiService
	xRequestId *string
	instanceId int64
	regionChangeRequest *RegionChangeRequest
	xTraceId *string
}

// [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
func (r ApiRequestRegionChangeRequest) XRequestId(xRequestId string) ApiRequestRegionChangeRequest {
	r.xRequestId = &xRequestId
	return r
}
func (r ApiRequestRegionChangeRequest) RegionChangeRequest(regionChangeRequest RegionChangeRequest) ApiRequestRegionChangeRequest {
	r.regionChangeRequest = &regionChangeRequest
	return r
}
// Identifier to trace group of requests.
func (r ApiRequestRegionChangeRequest) XTraceId(xTraceId string) ApiRequestRegionChangeRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiRequestRegionChangeRequest) Execute() (InstanceRegionChangeResponse, *_nethttp.Response, error) {
	return r.ApiService.RequestRegionChangeExecute(r)
}

/*
RequestRegionChange Request instance region change

Starts a region change for the instance via CMS. Returns the support ticket number when the operation was accepted.

 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param instanceId The identifier of the instance
 @return ApiRequestRegionChangeRequest
*/
func (a *InstancesApiService) RequestRegionChange(ctx _context.Context, instanceId int64) ApiRequestRegionChangeRequest {
	return ApiRequestRegionChangeRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
func (a *InstancesApiService) RequestRegionChangeExecute(r ApiRequestRegionChangeRequest) (InstanceRegionChangeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  InstanceRegionChangeResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InstancesApiService.RequestRegionChange")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/compute/instances/{instanceId}/regionChange"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", _neturl.PathEscape(parameterToString(r.instanceId, "")), -1)
	...
	if r.regionChangeRequest == nil {
		return localVarReturnValue, nil, reportError("regionChangeRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.regionChangeRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type ApiRetrieveAvailableInstanceProductsRequest struct {
	ctx _context.Context
	ApiService *InstancesApiService
	xRequestId *string
	instanceId int64
...
// [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
func (r ApiRetrieveAvailableInstanceProductsRequest) XRequestId(xRequestId string) ApiRetrieveAvailableInstanceProductsRequest {
	r.xRequestId = &xRequestId
	return r
}
// Identifier to trace group of requests.
func (r ApiRetrieveAvailableInstanceProductsRequest) XTraceId(xTraceId string) ApiRetrieveAvailableInstanceProductsRequest {
	r.xTraceId = &xTraceId
	return r
}

func (r ApiRetrieveAvailableInstanceProductsRequest) Execute() (ListInstanceProductsResponse, *_nethttp.Response, error) {
	return r.ApiService.RetrieveAvailableInstanceProductsExecute(r)
}

/*
RetrieveAvailableInstanceProducts Get the available products of a specific instance
...
Get all products the instance can be upgraded to, excluding the currently assigned one. Use the `offerId` of the desired product to submit the upgrade.
 ...
 @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param instanceId The identifier of the instance
 @return ApiRetrieveAvailableInstanceProductsRequest
*/
func (a *InstancesApiService) RetrieveAvailableInstanceProducts(ctx _context.Context, instanceId int64) ApiRetrieveAvailableInstanceProductsRequest {
	return ApiRetrieveAvailableInstanceProductsRequest{
		ApiService: a,
		ctx: ctx,
		instanceId: instanceId,
...
func (a *InstancesApiService) RetrieveAvailableInstanceProductsExecute(r ApiRetrieveAvailableInstanceProductsRequest) (ListInstanceProductsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
		localVarFileName     string
		localVarFileBytes    []byte
		localVarReturnValue  ListInstanceProductsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "InstancesApiService.RetrieveAvailableInstanceProducts")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/compute/instances/{instanceId}/products/available"
	localVarPath = strings.Replace(localVarPath, "{"+"instanceId"+"}", _neturl.PathEscape(parameterToString(r.instanceId, "")), -1)
...
// Filter instances by suspension state. When set to false, suspended instances are excluded from the response. Any other value returns all instances (default behavior).
func (r ApiRetrieveInstancesListRequest) Suspended(suspended bool) ApiRetrieveInstancesListRequest {
...
func (a *InstancesApiService) RetrieveInstancesListExecute(r ApiRetrieveInstancesListRequest) (ListInstancesResponse, *_nethttp.Response, error) {
	...
	if r.suspended != nil {
		localVarQueryParams.Add("suspended", parameterToString(*r.suspended, ""))
	}
	if r.search != nil {
