...
// SsoTokenResponse struct for SsoTokenResponse
type SsoTokenResponse struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// SSO token UUID used for single sign-on.
	SsoToken string `json:"ssoToken"`
	// SSO URL to redirect the user to my.contabo.com.
	Url string `json:"url"`
}
...
// GetSsoToken returns the SsoToken field value
...
// GetSsoTokenOk returns a tuple with the SsoToken field value
// and a boolean to check if the value has been set.
func (o *SsoTokenResponse) GetSsoTokenOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.SsoToken, true
}

// SetSsoToken sets field value
...
func (o SsoTokenResponse) MarshalJSON() ([]byte, error) {
	...
	if true {
		toSerialize["ssoToken"] = o.SsoToken
	}
	if true {
...
type NullableSsoTokenResponse struct {
	value *SsoTokenResponse
	isSet bool
}

func (v NullableSsoTokenResponse) Get() *SsoTokenResponse {
	return v.value
}

func (v *NullableSsoTokenResponse) Set(val *SsoTokenResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSsoTokenResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSsoTokenResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSsoTokenResponse(val *SsoTokenResponse) *NullableSsoTokenResponse {
	return &NullableSsoTokenResponse{value: val, isSet: true}
}

func (v NullableSsoTokenResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSsoTokenResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
