...
type CheckCollectionTemplatesCheckTemplates struct {
	...
	RemedyTemplates *[]RemedyTemplateSummary `json:"remedyTemplates,omitempty"`
...
// GetRemedyTemplates returns the RemedyTemplates field value if set, zero value otherwise.
func (o *CheckCollectionTemplatesCheckTemplates) GetRemedyTemplates() []RemedyTemplateSummary {
	if o == nil || o.RemedyTemplates == nil {
...
// GetRemedyTemplatesOk returns a tuple with the RemedyTemplates field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetRemedyTemplates gets a reference to the given []RemedyTemplateSummary and assigns it to the RemedyTemplates field.
