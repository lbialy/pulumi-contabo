...
const (
	...
	UNINSTALLED InstanceStatus = "uninstalled"
	RUNNING InstanceStatus = "running"
	STOPPED InstanceStatus = "stopped"
	ERROR InstanceStatus = "error"
	INSTALLING InstanceStatus = "installing"
	UNKNOWN InstanceStatus = "unknown"
	MANUAL_PROVISIONING InstanceStatus = "manual_provisioning"
	PRODUCT_NOT_AVAILABLE InstanceStatus = "product_not_available"
	VERIFICATION_REQUIRED InstanceStatus = "verification_required"
	RESCUE InstanceStatus = "rescue"
	PENDING_PAYMENT InstanceStatus = "pending_payment"
	OTHER InstanceStatus = "other"
	RESET_PASSWORD InstanceStatus = "reset_password"
)
