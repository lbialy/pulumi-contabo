...
// UpgradeInstanceProductRequest struct for UpgradeInstanceProductRequest
type UpgradeInstanceProductRequest struct {
	// ID of the upgrade offer as provided by the upgrade options.
	OfferId int64 `json:"offerId"`
	// Provisioning type for the upgrade. Use `installation` for a fresh installation or `migration` to keep the instance's existing data.
	ProvisioningType string `json:"provisioningType"`
	// ImageId of the image to install (only in case of `installation`).
	ImageId *string `json:"imageId,omitempty"`
	// ApplicationId of the panel to install (only in case of `installation`).
	ApplicationId *string `json:"applicationId,omitempty"`
	// Set to true to keep the storage extension addon (only for SSD and NVMe).
	StorageAddon *bool `json:"storageAddon,omitempty"`
	// Customer remarks for the upgrade.
...
func NewUpgradeInstanceProductRequest(offerId int64, provisioningType string) *UpgradeInstanceProductRequest {
	this := UpgradeInstanceProductRequest{}
...
// SetStorageAddon gets a reference to the given bool and assigns it to the StorageAddon field.
...
func (o UpgradeInstanceProductRequest) MarshalJSON() ([]byte, error) {
...
type NullableUpgradeInstanceProductRequest struct {
	value *UpgradeInstanceProductRequest
	isSet bool
}

func (v NullableUpgradeInstanceProductRequest) Get() *UpgradeInstanceProductRequest {
	return v.value
}

func (v *NullableUpgradeInstanceProductRequest) Set(val *UpgradeInstanceProductRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeInstanceProductRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeInstanceProductRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeInstanceProductRequest(val *UpgradeInstanceProductRequest) *NullableUpgradeInstanceProductRequest {
	return &NullableUpgradeInstanceProductRequest{value: val, isSet: true}
}

func (v NullableUpgradeInstanceProductRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeInstanceProductRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
