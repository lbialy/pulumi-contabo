...
// UpgradeInstanceProductData struct for UpgradeInstanceProductData
type UpgradeInstanceProductData struct {
	...
	// Support ticket number created for the upgrade
	TicketNumber string `json:"ticketNumber"`
	// Indicates whether the upgrade will be processed automatically or manually.
...
func NewUpgradeInstanceProductData(tenantId string, customerId string, instanceId int64, ticketNumber string, automatic bool) *UpgradeInstanceProductData {
	this := UpgradeInstanceProductData{}
...
// GetTicketNumber returns the TicketNumber field value
...
// GetTicketNumberOk returns a tuple with the TicketNumber field value
// and a boolean to check if the value has been set.
...
// SetTicketNumber sets field value
func (o *UpgradeInstanceProductData) SetTicketNumber(v string) {
	o.TicketNumber = v
}

// GetAutomatic returns the Automatic field value
...
// GetAutomaticOk returns a tuple with the Automatic field value
// and a boolean to check if the value has been set.
...
// SetAutomatic sets field value
func (o *UpgradeInstanceProductData) SetAutomatic(v bool) {
	o.Automatic = v
}

func (o UpgradeInstanceProductData) MarshalJSON() ([]byte, error) {
...
type NullableUpgradeInstanceProductData struct {
	value *UpgradeInstanceProductData
	isSet bool
}

func (v NullableUpgradeInstanceProductData) Get() *UpgradeInstanceProductData {
	return v.value
}

func (v *NullableUpgradeInstanceProductData) Set(val *UpgradeInstanceProductData) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeInstanceProductData) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeInstanceProductData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeInstanceProductData(val *UpgradeInstanceProductData) *NullableUpgradeInstanceProductData {
	return &NullableUpgradeInstanceProductData{value: val, isSet: true}
}

func (v NullableUpgradeInstanceProductData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeInstanceProductData) UnmarshalJSON(src []byte) error {
	v.isSet = true
