...
type CreateUserRequest struct {
	...
	// If enabled, the user receives invoice emails and is registered as an invoice contact in CMS. Only available for users with the Full Access role.
	SendInvoiceEmail *bool `json:"sendInvoiceEmail,omitempty"`
}
...
func NewCreateUserRequest(firstName string, lastName string, email string, enabled bool, totp bool, locale string) *CreateUserRequest {
...
// GetSendInvoiceEmail returns the SendInvoiceEmail field value if set, zero value otherwise.
func (o *CreateUserRequest) GetSendInvoiceEmail() bool {
	if o == nil || o.SendInvoiceEmail == nil {
		var ret bool
		return ret
	}
	return *o.SendInvoiceEmail
}

// GetSendInvoiceEmailOk returns a tuple with the SendInvoiceEmail field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CreateUserRequest) GetSendInvoiceEmailOk() (*bool, bool) {
	if o == nil || o.SendInvoiceEmail == nil {
		return nil, false
	}
	return o.SendInvoiceEmail, true
}

// HasSendInvoiceEmail returns a boolean if a field has been set.
func (o *CreateUserRequest) HasSendInvoiceEmail() bool {
	if o != nil && o.SendInvoiceEmail != nil {
		return true
	}
...
// SetSendInvoiceEmail gets a reference to the given bool and assigns it to the SendInvoiceEmail field.
func (o *CreateUserRequest) SetSendInvoiceEmail(v bool) {
	o.SendInvoiceEmail = &v
}
...
func (o CreateUserRequest) MarshalJSON() ([]byte, error) {
	...
	if o.SendInvoiceEmail != nil {
		toSerialize["sendInvoiceEmail"] = o.SendInvoiceEmail
	}
