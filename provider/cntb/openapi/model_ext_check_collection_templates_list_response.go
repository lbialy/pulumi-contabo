...
// ExtCheckCollectionTemplatesListResponse struct for ExtCheckCollectionTemplatesListResponse
type ExtCheckCollectionTemplatesListResponse struct {
...
func NewExtCheckCollectionTemplatesListResponse(pagination PaginationMeta, data []ExtCheckCollectionTemplateResponse, links Links) *ExtCheckCollectionTemplatesListResponse {
	this := ExtCheckCollectionTemplatesListResponse{}
...
func (o ExtCheckCollectionTemplatesListResponse) MarshalJSON() ([]byte, error) {
...
type NullableExtCheckCollectionTemplatesListResponse struct {
	value *ExtCheckCollectionTemplatesListResponse
	isSet bool
}

func (v NullableExtCheckCollectionTemplatesListResponse) Get() *ExtCheckCollectionTemplatesListResponse {
	return v.value
}

func (v *NullableExtCheckCollectionTemplatesListResponse) Set(val *ExtCheckCollectionTemplatesListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExtCheckCollectionTemplatesListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExtCheckCollectionTemplatesListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtCheckCollectionTemplatesListResponse(val *ExtCheckCollectionTemplatesListResponse) *NullableExtCheckCollectionTemplatesListResponse {
	return &NullableExtCheckCollectionTemplatesListResponse{value: val, isSet: true}
}

func (v NullableExtCheckCollectionTemplatesListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtCheckCollectionTemplatesListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
