...
// FindSsoTokenResponse struct for FindSsoTokenResponse
type FindSsoTokenResponse struct {
	Data []SsoTokenResponse `json:"data"`
...
func (o FindSsoTokenResponse) MarshalJSON() ([]byte, error) {
...
type NullableFindSsoTokenResponse struct {
	value *FindSsoTokenResponse
	isSet bool
}

func (v NullableFindSsoTokenResponse) Get() *FindSsoTokenResponse {
	return v.value
}

func (v *NullableFindSsoTokenResponse) Set(val *FindSsoTokenResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableFindSsoTokenResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableFindSsoTokenResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindSsoTokenResponse(val *FindSsoTokenResponse) *NullableFindSsoTokenResponse {
	return &NullableFindSsoTokenResponse{value: val, isSet: true}
}

func (v NullableFindSsoTokenResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindSsoTokenResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
