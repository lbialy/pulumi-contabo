...
// InstanceRegionChangeResponse struct for InstanceRegionChangeResponse
type InstanceRegionChangeResponse struct {
	Data []RegionChangeResponseData `json:"data"`
...
func NewInstanceRegionChangeResponse(data []RegionChangeResponseData, links SelfLinks) *InstanceRegionChangeResponse {
	this := InstanceRegionChangeResponse{}
	this.Data = data
	this.Links = links
	return &this
}
...
func (o *InstanceRegionChangeResponse) GetData() []RegionChangeResponseData {
	if o == nil {
		var ret []RegionChangeResponseData
		return ret
	}
...
func (o InstanceRegionChangeResponse) MarshalJSON() ([]byte, error) {
...
type NullableInstanceRegionChangeResponse struct {
	value *InstanceRegionChangeResponse
	isSet bool
}

func (v NullableInstanceRegionChangeResponse) Get() *InstanceRegionChangeResponse {
	return v.value
}

func (v *NullableInstanceRegionChangeResponse) Set(val *InstanceRegionChangeResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableInstanceRegionChangeResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableInstanceRegionChangeResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstanceRegionChangeResponse(val *InstanceRegionChangeResponse) *NullableInstanceRegionChangeResponse {
	return &NullableInstanceRegionChangeResponse{value: val, isSet: true}
}

func (v NullableInstanceRegionChangeResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstanceRegionChangeResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
