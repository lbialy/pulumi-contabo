...
// UserSwitchAccount struct for UserSwitchAccount
type UserSwitchAccount struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// The identifier of the sub user account.
	UserId string `json:"userId"`
	// The first name of the main account.
	FirstName string `json:"firstName"`
	// The last name of the main account.
	LastName string `json:"lastName"`
	// The email of the main account
	Email string `json:"email"`
	// Enable or disable two-factor authentication (2FA) via time based OTP.
	Totp bool `json:"totp"`
	// Flag to mark if the account is set as default
	Default bool `json:"default"`
	// The locale of the user. This can be `de-DE`, `de`, `en-US`, `en`
	Locale string `json:"locale"`
	// The name of the role.
	RoleName string `json:"roleName"`
	// If user is owner he will have permissions to all API endpoints and resources.
	Owner bool `json:"owner"`
	// Details about the primary account holder for this sub account.
...
func (o UserSwitchAccount) MarshalJSON() ([]byte, error) {
...
type NullableUserSwitchAccount struct {
	value *UserSwitchAccount
	isSet bool
}

func (v NullableUserSwitchAccount) Get() *UserSwitchAccount {
	return v.value
}

func (v *NullableUserSwitchAccount) Set(val *UserSwitchAccount) {
	v.value = val
	v.isSet = true
}

func (v NullableUserSwitchAccount) IsSet() bool {
	return v.isSet
}

func (v *NullableUserSwitchAccount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserSwitchAccount(val *UserSwitchAccount) *NullableUserSwitchAccount {
	return &NullableUserSwitchAccount{value: val, isSet: true}
}

func (v NullableUserSwitchAccount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserSwitchAccount) UnmarshalJSON(src []byte) error {
	v.isSet = true
