...
> ApiBulkDeleteDnsZoneRecordsResponse BulkDeleteDnsZoneRecords(ctx, zoneName).XRequestId(xRequestId).BulkDeleteDnsZoneRecordsRequest(bulkDeleteDnsZoneRecordsRequest).XTraceId(xTraceId).Execute()
...
func main() {
    ...
    bulkDeleteDnsZoneRecordsRequest := *openapiclient.NewBulkDeleteDnsZoneRecordsRequest([]int64{int64(123)}) // BulkDeleteDnsZoneRecordsRequest | 
    xTraceId := "xTraceId_example" // string | Identifier to trace group of requests. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.DNSApi.BulkDeleteDnsZoneRecords(context.Background(), zoneName).XRequestId(xRequestId).BulkDeleteDnsZoneRecordsRequest(bulkDeleteDnsZoneRecordsRequest).XTraceId(xTraceId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DNSApi.BulkDeleteDnsZoneRecords``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `BulkDeleteDnsZoneRecords`: ApiBulkDeleteDnsZoneRecordsResponse
    fmt.Fprintf(os.Stdout, "Response from `DNSApi.BulkDeleteDnsZoneRecords`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiBulkDeleteDnsZoneRecordsRequest struct via the builder pattern
 ...
 **bulkDeleteDnsZoneRecordsRequest** | [**BulkDeleteDnsZoneRecordsRequest**](BulkDeleteDnsZoneRecordsRequest.md) |  | 
...
func main() {
    xRequestId := "04e0f898-37b4-48bc-a794-1a57abe6aa31" // string | [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
    createPtrRecordRequest := *openapiclient.NewCreatePtrRecordRequest("vmd1027177.server.net", "1:2:3:4:5:6:7:8", int64(86400)) // CreatePtrRecordRequest | 
    xTraceId := "xTraceId_example" // string | Identifier to trace group of requests. (optional)
...
> DeleteDnsZoneRecord(ctx, recordId, zoneName).XRequestId(xRequestId).XTraceId(xTraceId).Execute()
...
func main() {
    xRequestId := "04e0f898-37b4-48bc-a794-1a57abe6aa31" // string | [Uuid4](https://en.wikipedia.org/wiki/Universally_unique_identifier#Version_4_(random)) to identify individual requests for support cases. You can use [uuidgenerator](https://www.uuidgenerator.net/version4) to generate them manually.
    recordId := int64(12345) // int64 | The identifier of the DNS record
    zoneName := "example.com" // string | Zone name
    xTraceId := "xTraceId_example" // string | Identifier to trace group of requests. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.DNSApi.DeleteDnsZoneRecord(context.Background(), recordId, zoneName).XRequestId(xRequestId).XTraceId(xTraceId).Execute()
    if err != nil {
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**recordId** | **int64** | The identifier of the DNS record | 
**zoneName** | **string** | Zone name | 
...
> ListDnsZoneRecordsResponse RetrieveDnsZoneRecordsList(ctx, zoneName).XRequestId(xRequestId).XTraceId(xTraceId).Page(page).Size(size).OrderBy(orderBy).Search(search).Execute()
...
func main() {
    ...
    search := "example.com" // string | Search DNS records by name, type or data (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.DNSApi.RetrieveDnsZoneRecordsList(context.Background(), zoneName).XRequestId(xRequestId).XTraceId(xTraceId).Page(page).Size(size).OrderBy(orderBy).Search(search).Execute()
    if err != nil {
 ...
 **search** | **string** | Search DNS records by name, type or data | 
...
func main() {
    ...
    zoneName := "example.com" // string | Seach by zone name (optional)
 ...
 **zoneName** | **string** | Seach by zone name | 
...
> ListPtrRecordsResponse RetrievePtrRecordsList(ctx).XRequestId(xRequestId).XTraceId(xTraceId).Page(page).Size(size).OrderBy(orderBy).CustomerId(customerId).TenantId(tenantId).Ips(ips).Search(search).Execute()
...
func main() {
    ...
    search := "vmd1111.contabo.net" // string | Search PTR records by ip or data (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.DNSApi.RetrievePtrRecordsList(context.Background()).XRequestId(xRequestId).XTraceId(xTraceId).Page(page).Size(size).OrderBy(orderBy).CustomerId(customerId).TenantId(tenantId).Ips(ips).Search(search).Execute()
    if err != nil {
 ...
 **search** | **string** | Search PTR records by ip or data | 
...
> ApiDnsZoneRecordResponse UpdateDnsZoneRecord(ctx, recordId, zoneName).XRequestId(xRequestId).UpdateDnsZoneRecordRequest(updateDnsZoneRecordRequest).XTraceId(xTraceId).Execute()
...
func main() {
    ...
    recordId := int64(12345) // int64 | The identifier of the DNS record
    zoneName := "example.com" // string | Zone name
    updateDnsZoneRecordRequest := *openapiclient.NewUpdateDnsZoneRecordRequest(float32(86400), float32(0), "A", "10.0.0.1") // UpdateDnsZoneRecordRequest | 
    xTraceId := "xTraceId_example" // string | Identifier to trace group of requests. (optional)

    configuration := openapiclient.NewConfiguration()
    api_client := openapiclient.NewAPIClient(configuration)
    resp, r, err := api_client.DNSApi.UpdateDnsZoneRecord(context.Background(), recordId, zoneName).XRequestId(xRequestId).UpdateDnsZoneRecordRequest(updateDnsZoneRecordRequest).XTraceId(xTraceId).Execute()
    if err != nil {
        fmt.Fprintf(os.Stderr, "Error when calling `DNSApi.UpdateDnsZoneRecord``: %v\n", err)
        fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
    }
    // response from `UpdateDnsZoneRecord`: ApiDnsZoneRecordResponse
    fmt.Fprintf(os.Stdout, "Response from `DNSApi.UpdateDnsZoneRecord`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiUpdateDnsZoneRecordRequest struct via the builder pattern
 ...
 **updateDnsZoneRecordRequest** | [**UpdateDnsZoneRecordRequest**](UpdateDnsZoneRecordRequest.md) |  | 
 **xTraceId** | **string** | Identifier to trace group of requests. | 
