...
type HandleResponse struct {
	...
	// NIC.it entity type. Present for .it registrant contacts. Valid values: natural_person, individual_firm, non_profit, public_org, other, company, foreign_legal_entity.
