...
// RegionChangeResponseData struct for RegionChangeResponseData
type RegionChangeResponseData struct {
	// Your customer tenant id
	TenantId string `json:"tenantId"`
	// Your customer number
	CustomerId string `json:"customerId"`
	// Support ticket number created for the region change
...
func (o RegionChangeResponseData) MarshalJSON() ([]byte, error) {
...
type NullableRegionChangeResponseData struct {
	value *RegionChangeResponseData
	isSet bool
}

func (v NullableRegionChangeResponseData) Get() *RegionChangeResponseData {
	return v.value
}

func (v *NullableRegionChangeResponseData) Set(val *RegionChangeResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableRegionChangeResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableRegionChangeResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegionChangeResponseData(val *RegionChangeResponseData) *NullableRegionChangeResponseData {
	return &NullableRegionChangeResponseData{value: val, isSet: true}
}

func (v NullableRegionChangeResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegionChangeResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
