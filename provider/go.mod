module github.com/lbialy/pulumi-contabo/provider

go 1.25.11

replace (
	// The upstream Terraform provider declares this module but git-ignores the generated
	// sources, so we vendor a generated copy. See scripts/regen-openapi.sh.
	contabo.com/openapi => ./cntb/openapi
	// The upstream Terraform provider's module path does not match its repository.
	contabo.com/terraform-provider-contabo => github.com/contabo/terraform-provider-contabo v0.1.44
	// Required by pulumi-terraform-bridge, which carries the same replace in its own go.mod.
...
require (
	contabo.com/terraform-provider-contabo v0.1.44
