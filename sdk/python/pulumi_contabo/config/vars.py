...
class _ExportableConfig(types.ModuleType):
    ...
    def api(self) -> Optional[str]:
        ...
        """
        return __config__.get('api') or _utilities.get_env('CNTB_API', 'CONTABO_API')
    ...
    def oauth2_client_id(self) -> Optional[str]:
        ...
        """
        return __config__.get('oauth2ClientId') or _utilities.get_env('CNTB_OAUTH2_CLIENT_ID', 'CONTABO_OAUTH2_CLIENT_ID')
    ...
    def oauth2_client_secret(self) -> Optional[str]:
        ...
        """
        return __config__.get('oauth2ClientSecret') or _utilities.get_env('CNTB_OAUTH2_CLIENT_SECRET', 'CONTABO_OAUTH2_CLIENT_SECRET')
    ...
    def oauth2_pass(self) -> Optional[str]:
        ...
        """
        return __config__.get('oauth2Pass') or _utilities.get_env('CNTB_OAUTH2_PASS', 'CONTABO_OAUTH2_PASS')
    ...
    def oauth2_token_url(self) -> Optional[str]:
        ...
        """
        return __config__.get('oauth2TokenUrl') or _utilities.get_env('CNTB_OAUTH2_TOKEN_URL', 'CONTABO_OAUTH2_TOKEN_URL')
    ...
    def oauth2_user(self) -> Optional[str]:
        ...
        """
        return __config__.get('oauth2User') or _utilities.get_env('CNTB_OAUTH2_USER', 'CONTABO_OAUTH2_USER')
