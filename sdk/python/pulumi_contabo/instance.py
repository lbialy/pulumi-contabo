...
class InstanceArgs:
    def __init__(__self__, *,
                 add_ons: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAddOnArgs']]]] = None,
                 cancel_date: pulumi.Input[Optional[_builtins.str]] = None,
                 default_user: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 existing_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 root_password: pulumi.Input[Optional[_builtins.int]] = None,
                 ssh_keys: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 user_data: pulumi.Input[Optional[_builtins.str]] = None):
        """
        The set of arguments for constructing a Instance resource.

        :param pulumi.Input[_builtins.str] cancel_date: The date on which the instance will be cancelled.
        :param pulumi.Input[_builtins.str] default_user: Default user name created for login during (re-)installation with administrative privileges. Allowed values for Linux/BSD are admin (use sudo to apply administrative privileges like root) or root. Allowed values for Windows are admin (has administrative privileges like administrator) or administrator.
        ...
        :param pulumi.Input[_builtins.str] existing_instance_id: The identifier of the existing compute instance. (override id)
        :param pulumi.Input[_builtins.str] image_id: CAUTION: On updating this value your server will be reinstalled! Image Id is used to set up the compute instance. Ubuntu 20.04 is the default, currently you have to get the Id with our [API](https://api.contabo.com/#tag/Images/operation/retrieveImage) or via our [command line](https://github.com/contabo/cntb) tool with this command: `cntb get images`.
        :param pulumi.Input[_builtins.str] license: Additional license in order to enhance your chosen product. It is mainly needed for software licenses on your product (not needed for windows). See our [api documentation](https://api.contabo.com/#tag/Instances/operation/createInstance) for all available licenses.
        :param pulumi.Input[_builtins.int] period: Initial contract period in months. Available periods are: 1, 3, 6 and 12 months. The default setting is 1 month.
        :param pulumi.Input[_builtins.str] product_id: Choose the VPS/VDS product you want to buy. See our products [here](https://api.contabo.com/#tag/Instances/operation/createInstance).
        :param pulumi.Input[_builtins.str] region: Instance Region where the compute instance should be located. Default region is the EU. Following regions are available: `EU`,`US-central`,`US-east`,`US-west`,`SIN`.
        :param pulumi.Input[_builtins.int] root_password: CAUTION: On updating this value your server will be reinstalled! Root password of the compute instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] ssh_keys: CAUTION: On updating this value your server will be reinstalled! Array of `secretIds` of public SSH keys for logging into as defaultUser with administrator/root privileges. Applies to Linux/BSD systems. Please refer to Secrets Management API.
        :param pulumi.Input[_builtins.str] user_data: CAUTION: On updating this value your server will be reinstalled! Cloud-Init Config in order to customize during start of compute instance.
        """
        ...
        if existing_instance_id is not None:
            pulumi.set(__self__, "existing_instance_id", existing_instance_id)
    ...
    def add_ons(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAddOnArgs']]]]:
        return pulumi.get(self, "add_ons")

    @add_ons.setter
    def add_ons(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAddOnArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="existingInstanceId")
    def existing_instance_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The identifier of the existing compute instance. (override id)
        """
        return pulumi.get(self, "existing_instance_id")

    @existing_instance_id.setter
    def existing_instance_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "existing_instance_id", value)
    ...
    def root_password(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def root_password(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "root_password", value)

    @_builtins.property
    @pulumi.getter(name="sshKeys")
    def ssh_keys(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]:
        """
    ...
    @ssh_keys.setter
    def ssh_keys(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]]):
...
class _InstanceState:
    def __init__(__self__, *,
                 add_ons: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAddOnArgs']]]] = None,
                 additional_ips: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAdditionalIpArgs']]]] = None,
                 cancel_date: pulumi.Input[Optional[_builtins.str]] = None,
                 cpu_cores: pulumi.Input[Optional[_builtins.int]] = None,
                 created_date: pulumi.Input[Optional[_builtins.str]] = None,
                 default_user: pulumi.Input[Optional[_builtins.str]] = None,
                 disk_mb: pulumi.Input[Optional[_builtins.int]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 error_message: pulumi.Input[Optional[_builtins.str]] = None,
                 existing_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 image_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ip_configs: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceIpConfigArgs']]]] = None,
                 ...
                 ram_mb: pulumi.Input[Optional[_builtins.int]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 root_password: pulumi.Input[Optional[_builtins.int]] = None,
                 ssh_keys: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.int]]]] = None,
                 status: pulumi.Input[Optional[_builtins.str]] = None,
                 user_data: pulumi.Input[Optional[_builtins.str]] = None,
                 v_host_id: pulumi.Input[Optional[_builtins.int]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] cancel_date: The date on which the instance will be cancelled.
        :param pulumi.Input[_builtins.int] cpu_cores: CPU core count of the instance.
        :param pulumi.Input[_builtins.str] created_date: The creation date of the compute instance.
        :param pulumi.Input[_builtins.str] default_user: Default user name created for login during (re-)installation with administrative privileges. Allowed values for Linux/BSD are admin (use sudo to apply administrative privileges like root) or root. Allowed values for Windows are admin (has administrative privileges like administrator) or administrator.
        :param pulumi.Input[_builtins.int] disk_mb: Image disk size of the instance in megabyte.
        :param pulumi.Input[_builtins.str] display_name: The instance name chosen by the customer that will be shown in the customer panel.
        ...
        :param pulumi.Input[_builtins.str] existing_instance_id: The identifier of the existing compute instance. (override id)
        :param pulumi.Input[_builtins.str] image_id: CAUTION: On updating this value your server will be reinstalled! Image Id is used to set up the compute instance. Ubuntu 20.04 is the default, currently you have to get the Id with our [API](https://api.contabo.com/#tag/Images/operation/retrieveImage) or via our [command line](https://github.com/contabo/cntb) tool with this command: `cntb get images`.
        :param pulumi.Input[_builtins.str] last_updated: Time of the last update of the compute instance.
        :param pulumi.Input[_builtins.str] license: Additional license in order to enhance your chosen product. It is mainly needed for software licenses on your product (not needed for windows). See our [api documentation](https://api.contabo.com/#tag/Instances/operation/createInstance) for all available licenses.
        :param pulumi.Input[_builtins.str] mac_address: Mac address of the instance.
        :param pulumi.Input[_builtins.str] name: Name of the compute instance.
        :param pulumi.Input[_builtins.str] os_type: Type of operating system (OS) installed on the instance.
        :param pulumi.Input[_builtins.int] period: Initial contract period in months. Available periods are: 1, 3, 6 and 12 months. The default setting is 1 month.
        :param pulumi.Input[_builtins.str] product_id: Choose the VPS/VDS product you want to buy. See our products [here](https://api.contabo.com/#tag/Instances/operation/createInstance).
        :param pulumi.Input[_builtins.str] product_type: InsInstance's category depending on Product Id. Following product types are available: `hdd`,`ssd`,`vds`,`nvme`.
        :param pulumi.Input[_builtins.int] ram_mb: Image ram size in megabyte.
        :param pulumi.Input[_builtins.str] region: Instance Region where the compute instance should be located. Default region is the EU. Following regions are available: `EU`,`US-central`,`US-east`,`US-west`,`SIN`.
        :param pulumi.Input[_builtins.int] root_password: CAUTION: On updating this value your server will be reinstalled! Root password of the compute instance.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.int]]] ssh_keys: CAUTION: On updating this value your server will be reinstalled! Array of `secretIds` of public SSH keys for logging into as defaultUser with administrator/root privileges. Applies to Linux/BSD systems. Please refer to Secrets Management API.
        :param pulumi.Input[_builtins.str] status: Status of the compute instance. The status can be set to `provisioning`, `uninstalled`, `running`, `stopped`, `error`, `installing`, `unknown`, or `installed`.
        :param pulumi.Input[_builtins.str] user_data: CAUTION: On updating this value your server will be reinstalled! Cloud-Init Config in order to customize during start of compute instance.
        :param pulumi.Input[_builtins.int] v_host_id: Identifier of the host system.
        """
        if add_ons is not None:
            pulumi.set(__self__, "add_ons", add_ons)
    ...
    def additional_ips(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAdditionalIpArgs']]]]:
        """
    ...
    def additional_ips(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceAdditionalIpArgs']]]]):
    ...
    def cpu_cores(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @cpu_cores.setter
    def cpu_cores(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def disk_mb(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @disk_mb.setter
    def disk_mb(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def ip_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['InstanceIpConfigArgs']]]]:
        return pulumi.get(self, "ip_configs")

    @ip_configs.setter
    def ip_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['InstanceIpConfigArgs']]]]):
    ...
    def ram_mb(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @ram_mb.setter
    def ram_mb(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def v_host_id(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @v_host_id.setter
    def v_host_id(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "v_host_id", value)


@pulumi.type_token("contabo:index/instance:Instance")
class Instance(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["existing_instance_id"] = existing_instance_id
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            add_ons: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceAddOnArgs', 'InstanceAddOnArgsDict']]]]] = None,
            additional_ips: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceAdditionalIpArgs', 'InstanceAdditionalIpArgsDict']]]]] = None,
            cancel_date: pulumi.Input[Optional[_builtins.str]] = None,
            cpu_cores: pulumi.Input[Optional[_builtins.int]] = None,
            created_date: pulumi.Input[Optional[_builtins.str]] = None,
            default_user: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            existing_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
            image_id: pulumi.Input[Optional[_builtins.str]] = None,
            ip_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['InstanceIpConfigArgs', 'InstanceIpConfigArgsDict']]]]] = None,
            last_updated: pulumi.Input[Optional[_builtins.str]] = None,
            license: pulumi.Input[Optional[_builtins.str]] = None,
            mac_address: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            user_data: pulumi.Input[Optional[_builtins.str]] = None,
            v_host_id: pulumi.Input[Optional[_builtins.int]] = None) -> 'Instance':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['InstanceAdditionalIpArgs', 'InstanceAdditionalIpArgsDict']]]] additional_ips: All other additional IP addresses of the instance.
        :param pulumi.Input[_builtins.str] cancel_date: The date on which the instance will be cancelled.
        :param pulumi.Input[_builtins.int] cpu_cores: CPU core count of the instance.
        :param pulumi.Input[_builtins.str] created_date: The creation date of the compute instance.
        :param pulumi.Input[_builtins.str] default_user: Default user name created for login during (re-)installation with administrative privileges. Allowed values for Linux/BSD are admin (use sudo to apply administrative privileges like root) or root. Allowed values for Windows are admin (has administrative privileges like administrator) or administrator.
    ...
    @_builtins.property
    @pulumi.getter(name="cancelDate")
    def cancel_date(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The date on which the instance will be cancelled.
        """
        return pulumi.get(self, "cancel_date")
    ...
    @_builtins.property
    @pulumi.getter(name="cpuCores")
    def cpu_cores(self) -> pulumi.Output[_builtins.int]:
        """
        CPU core count of the instance.
        """
        return pulumi.get(self, "cpu_cores")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultUser")
    def default_user(self) -> pulumi.Output[_builtins.str]:
        """
        Default user name created for login during (re-)installation with administrative privileges. Allowed values for Linux/BSD are admin (use sudo to apply administrative privileges like root) or root. Allowed values for Windows are admin (has administrative privileges like administrator) or administrator.
        """
        return pulumi.get(self, "default_user")
    ...
    @_builtins.property
    @pulumi.getter(name="diskMb")
    def disk_mb(self) -> pulumi.Output[_builtins.int]:
        """
        Image disk size of the instance in megabyte.
        """
        return pulumi.get(self, "disk_mb")
    ...
    @_builtins.property
    @pulumi.getter(name="existingInstanceId")
    def existing_instance_id(self) -> pulumi.Output[_builtins.str]:
        """
        The identifier of the existing compute instance. (override id)
        """
        return pulumi.get(self, "existing_instance_id")
    ...
    @_builtins.property
    @pulumi.getter(name="ramMb")
    def ram_mb(self) -> pulumi.Output[_builtins.int]:
        """
        Image ram size in megabyte.
        """
        return pulumi.get(self, "ram_mb")
    ...
    @_builtins.property
    @pulumi.getter(name="rootPassword")
    def root_password(self) -> pulumi.Output[Optional[_builtins.int]]:
        """
        CAUTION: On updating this value your server will be reinstalled! Root password of the compute instance.
        """
        return pulumi.get(self, "root_password")
    ...
    @_builtins.property
    @pulumi.getter(name="sshKeys")
    def ssh_keys(self) -> pulumi.Output[Sequence[_builtins.int]]:
        """
        CAUTION: On updating this value your server will be reinstalled! Array of `secretIds` of public SSH keys for logging into as defaultUser with administrator/root privileges. Applies to Linux/BSD systems. Please refer to Secrets Management API.
        """
        return pulumi.get(self, "ssh_keys")
    ...
    @_builtins.property
    @pulumi.getter(name="vHostId")
    def v_host_id(self) -> pulumi.Output[_builtins.int]:
        """
        Identifier of the host system.
        """
        return pulumi.get(self, "v_host_id")
