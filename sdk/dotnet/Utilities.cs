...
namespace Lbialy.Contabo
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/lbialy/pulumi-contabo";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Lbialy.Contabo.version.txt");
    ...
    internal sealed class ContaboResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public ContaboResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
